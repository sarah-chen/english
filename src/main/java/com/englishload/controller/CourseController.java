...
//	@RequiresPermissions("user:userlist")
	...
	/**
	 * @author taojian
	 * @time 2017年2月20日下午4:53:53
	 * @methodname updateByCourseId
	 * @descripe 课程修改功能
	 */
	@RequestMapping("updateByCourseId")
	public ModelAndView updateByCourseId(
		...
		int b=courseUserService.updateCourseUser(courseUser);
		...
		gradecategoryCourse.setCourseId(course.getCourseId());
		gradecategoryCourse.setGradeId(gradeId);
		int c=gradecategoryCourseService.updateGradecategoryCourse(gradecategoryCourse);
